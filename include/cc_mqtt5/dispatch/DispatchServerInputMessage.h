...
/// @note Defined in cc_mqtt5/dispatch/DispatchServerInputMessage.h
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<cc_mqtt5::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<cc_mqtt5::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_mqtt5::options::DefaultOptions.
/// @headerfile cc_mqtt5/dispatch/DispatchServerInputMessage.h
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(cc_mqtt5::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_mqtt5::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_mqtt5::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(cc_mqtt5::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(cc_mqtt5::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return cc_mqtt5::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
