...
#include <tuple>
#include "cc_mqtt5/MessageCommon.h"
...
struct MessageFields
{
    ...
    struct FlagsMembers
    {
        ...
        public:
            ...
            /// @see @ref cc_mqtt5::MessageFieldsCommon::FlagsMembersCommon::RetainCommon::bitName().
            static const char* bitName(std::size_t idx)
            {
                return cc_mqtt5::MessageFieldsCommon::FlagsMembersCommon::RetainCommon::bitName(idx);
            }
            ...
            {
                return cc_mqtt5::MessageFieldsCommon::FlagsMembersCommon::RetainCommon::name();
            }
        };
        ...
        public:
            ...
            /// @brief Retrieve name of the bit.
            /// @see @ref cc_mqtt5::MessageFieldsCommon::FlagsMembersCommon::DupCommon::bitName().
            static const char* bitName(std::size_t idx)
            {
                return cc_mqtt5::MessageFieldsCommon::FlagsMembersCommon::DupCommon::bitName(idx);
            }
            ...
            static const char* name()
            {
                return cc_mqtt5::MessageFieldsCommon::FlagsMembersCommon::DupCommon::name();
            }
        };
    ...
    public:
        ...
        ///         for cc_mqtt5::MessageFields::FlagsMembers::Retain member field.
        ///     @li @b FieldIdx_qos index, @b Field_qos type and @b field_qos() access function -
        ///         for cc_mqtt5::MessageFields::FlagsMembers::Qos member field.
        ///     @li @b FieldIdx_dup index, @b Field_dup type and @b field_dup() access function -
        ///         for cc_mqtt5::MessageFields::FlagsMembers::Dup member field.
        ...
        static const char* name()
        {
            return cc_mqtt5::MessageFieldsCommon::FlagsCommon::name();
        }
    };
...
class Message : public
    comms::Message<
        ...
        comms::option::def::MsgIdType<cc_mqtt5::MsgId>,
