...
#include "cc_mqtt5/message/ConnackCommon.h"
...
/// @see @ref Connack
/// @headerfile cc_mqtt5/message/Connack.h
...
struct ConnackFields
{
    ...
    public:
        ...
        /// @see @ref cc_mqtt5::message::ConnackFieldsCommon::FlagsCommon::bitName().
        static const char* bitName(std::size_t idx)
        {
            return cc_mqtt5::message::ConnackFieldsCommon::FlagsCommon::bitName(idx);
        }
        ...
        {
            return cc_mqtt5::message::ConnackFieldsCommon::FlagsCommon::name();
        }
    };
    ...
    using Properties =
        cc_mqtt5::field::PropertiesList<
            TOpt,
            typename TOpt::message::ConnackFields::Properties,
            comms::option::def::HasName
        >;
...
class Connack : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<cc_mqtt5::MsgId_Connack>,
...
public:
    ...
    {
        return cc_mqtt5::message::ConnackCommon::name();
    }
