...
struct ConnectFields
{
    ...
    struct FlagsMembers
    {
        ...
        public:
            ...
            {
                return cc_mqtt5::message::ConnectFieldsCommon::FlagsMembersCommon::LowCommon::bitName(idx);
            }
        ...
        public:
            ...
            static const char* bitName(std::size_t idx)
            {
                return cc_mqtt5::message::ConnectFieldsCommon::FlagsMembersCommon::HighCommon::bitName(idx);
            }
...
public:
    ...
    static_assert(MsgMinLen == 9, "Unexpected min serialisation length");
