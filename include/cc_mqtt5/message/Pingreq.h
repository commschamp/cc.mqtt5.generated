...
#include "cc_mqtt5/message/PingreqCommon.h"
...
/// @see @ref Pingreq
/// @headerfile cc_mqtt5/message/Pingreq.h
...
class Pingreq : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<cc_mqtt5::MsgId_Pingreq>,
...
public:
    ...
    {
        return cc_mqtt5::message::PingreqCommon::name();
    }
