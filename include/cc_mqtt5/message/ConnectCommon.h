...
struct ConnectFieldsCommon
{
    ...
    {
        /// @brief Common definitions of the member fields of
        ///     @ref cc_mqtt5::message::ConnectFields::WillPropertiesMembers::ActWillProperties field.
        using ActWillPropertiesMembersCommon = cc_mqtt5::field::PropertiesListMembersCommon;

        /// @brief Common types and functions for
        ///     @ref cc_mqtt5::message::ConnectFields::WillPropertiesMembers::ActWillProperties field.
        struct ActWillPropertiesCommon : public cc_mqtt5::field::PropertiesListCommon
        {
            /// @brief Name of the @ref cc_mqtt5::message::ConnectFields::WillPropertiesMembers::ActWillProperties field.
            static const char* name()
            {
