...
#include "cc_mqtt5/message/UnsubscribeCommon.h"
...
/// @see @ref Unsubscribe
/// @headerfile cc_mqtt5/message/Unsubscribe.h
...
struct UnsubscribeFields
{
    ...
    using Properties =
        cc_mqtt5::field::PropertiesList<
            TOpt,
            typename TOpt::message::UnsubscribeFields::Properties,
            comms::option::def::HasName
        >;
    ...
    public:
        ...
        {
            return cc_mqtt5::message::UnsubscribeFieldsCommon::ListCommon::name();
        }
    };
...
class Unsubscribe : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<cc_mqtt5::MsgId_Unsubscribe>,
...
public:
    ...
    {
        return cc_mqtt5::message::UnsubscribeCommon::name();
    }
