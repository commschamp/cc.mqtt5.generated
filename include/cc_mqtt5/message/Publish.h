...
#include "cc_mqtt5/message/PublishCommon.h"
...
/// @see @ref Publish
/// @headerfile cc_mqtt5/message/Publish.h
...
struct PublishFields
{
    ...
    public:
        ...
        {
            return cc_mqtt5::message::PublishFieldsCommon::PacketIdCommon::name();
        }
    };
    ...
    using Properties =
        cc_mqtt5::field::PropertiesList<
            TOpt,
            typename TOpt::message::PublishFields::Properties,
            comms::option::def::HasName
        >;
    ...
    public:
        ...
        static const char* name()
        {
            return cc_mqtt5::message::PublishFieldsCommon::PayloadCommon::name();
        }
    };
...
class Publish : public
    comms::MessageBase<
        TMsgBase,
        comms::option::def::StaticNumIdImpl<cc_mqtt5::MsgId_Publish>,
...
public:
    ...
    {
        return cc_mqtt5::message::PublishCommon::name();
    }
