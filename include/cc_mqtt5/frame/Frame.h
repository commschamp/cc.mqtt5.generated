    ...
    struct IdAndFlagsMembers
    {
        ...
        struct IdAndFlagsFieldMembers
        {
            ...
            public:
                ...
                static constexpr bool hasSpecials()
                {
                    return cc_mqtt5::frame::FrameLayersCommon::IdAndFlagsMembersCommon::IdAndFlagsFieldMembersCommon::FlagsCommon::hasSpecials();
                }

                /// @brief Name of the field.
                static const char* name()
                {
                    return cc_mqtt5::frame::FrameLayersCommon::IdAndFlagsMembersCommon::IdAndFlagsFieldMembersCommon::FlagsCommon::name();
                }
            };

            /// @brief Definition of <b>"Id"</b> field.
            class Id : public
                cc_mqtt5::field::MsgId<
                    TOpt,
                    comms::option::def::FixedBitLength<4U>
                >
            {
            ...
            public:
                ...
                static const char* name()
                {
                    return cc_mqtt5::frame::FrameLayersCommon::IdAndFlagsMembersCommon::IdAndFlagsFieldMembersCommon::IdCommon::name();
                }
            };
        ...
        public:
            ...
            ///         for cc_mqtt5::frame::FrameLayers::IdAndFlagsMembers::IdAndFlagsFieldMembers::Flags member field.
            ///     @li @b FieldIdx_id index, @b Field_id type and @b field_id() access function -
            ///         for cc_mqtt5::frame::FrameLayers::IdAndFlagsMembers::IdAndFlagsFieldMembers::Id member field.
            ...
            static const char* name()
            {
                return cc_mqtt5::frame::FrameLayersCommon::IdAndFlagsMembersCommon::IdAndFlagsFieldCommon::name();
            }
        };
    };
