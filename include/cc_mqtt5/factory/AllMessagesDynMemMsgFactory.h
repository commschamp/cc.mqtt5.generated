...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (id) {
            case cc_mqtt5::MsgId_Connect: return MsgPtr(new cc_mqtt5::message::Connect<TInterface, TProtOptions>);
            case cc_mqtt5::MsgId_Connack: return MsgPtr(new cc_mqtt5::message::Connack<TInterface, TProtOptions>);
            case cc_mqtt5::MsgId_Publish: return MsgPtr(new cc_mqtt5::message::Publish<TInterface, TProtOptions>);
            case cc_mqtt5::MsgId_Puback: return MsgPtr(new cc_mqtt5::message::Puback<TInterface, TProtOptions>);
            case cc_mqtt5::MsgId_Pubrec: return MsgPtr(new cc_mqtt5::message::Pubrec<TInterface, TProtOptions>);
            case cc_mqtt5::MsgId_Pubrel: return MsgPtr(new cc_mqtt5::message::Pubrel<TInterface, TProtOptions>);
            case cc_mqtt5::MsgId_Pubcomp: return MsgPtr(new cc_mqtt5::message::Pubcomp<TInterface, TProtOptions>);
            case cc_mqtt5::MsgId_Subscribe: return MsgPtr(new cc_mqtt5::message::Subscribe<TInterface, TProtOptions>);
            case cc_mqtt5::MsgId_Suback: return MsgPtr(new cc_mqtt5::message::Suback<TInterface, TProtOptions>);
            case cc_mqtt5::MsgId_Unsubscribe: return MsgPtr(new cc_mqtt5::message::Unsubscribe<TInterface, TProtOptions>);
            case cc_mqtt5::MsgId_Unsuback: return MsgPtr(new cc_mqtt5::message::Unsuback<TInterface, TProtOptions>);
            case cc_mqtt5::MsgId_Pingreq: return MsgPtr(new cc_mqtt5::message::Pingreq<TInterface, TProtOptions>);
            case cc_mqtt5::MsgId_Pingresp: return MsgPtr(new cc_mqtt5::message::Pingresp<TInterface, TProtOptions>);
            case cc_mqtt5::MsgId_Disconnect: return MsgPtr(new cc_mqtt5::message::Disconnect<TInterface, TProtOptions>);
            case cc_mqtt5::MsgId_Auth: return MsgPtr(new cc_mqtt5::message::Auth<TInterface, TProtOptions>);
            default: break;
        }
