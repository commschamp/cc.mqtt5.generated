...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (static_cast<std::intmax_t>(id)) {
            case 1 /* 0x1 */: return MsgPtr(new cc_mqtt5::message::Connect<TInterface, TProtOptions>);
            case 2 /* 0x2 */: return MsgPtr(new cc_mqtt5::message::Connack<TInterface, TProtOptions>);
            case 3 /* 0x3 */: return MsgPtr(new cc_mqtt5::message::Publish<TInterface, TProtOptions>);
            case 4 /* 0x4 */: return MsgPtr(new cc_mqtt5::message::Puback<TInterface, TProtOptions>);
            case 5 /* 0x5 */: return MsgPtr(new cc_mqtt5::message::Pubrec<TInterface, TProtOptions>);
            case 6 /* 0x6 */: return MsgPtr(new cc_mqtt5::message::Pubrel<TInterface, TProtOptions>);
            case 7 /* 0x7 */: return MsgPtr(new cc_mqtt5::message::Pubcomp<TInterface, TProtOptions>);
            case 8 /* 0x8 */: return MsgPtr(new cc_mqtt5::message::Subscribe<TInterface, TProtOptions>);
            case 9 /* 0x9 */: return MsgPtr(new cc_mqtt5::message::Suback<TInterface, TProtOptions>);
            case 10 /* 0xa */: return MsgPtr(new cc_mqtt5::message::Unsubscribe<TInterface, TProtOptions>);
            case 11 /* 0xb */: return MsgPtr(new cc_mqtt5::message::Unsuback<TInterface, TProtOptions>);
            case 12 /* 0xc */: return MsgPtr(new cc_mqtt5::message::Pingreq<TInterface, TProtOptions>);
            case 13 /* 0xd */: return MsgPtr(new cc_mqtt5::message::Pingresp<TInterface, TProtOptions>);
            case 14 /* 0xe */: return MsgPtr(new cc_mqtt5::message::Disconnect<TInterface, TProtOptions>);
            case 15 /* 0xf */: return MsgPtr(new cc_mqtt5::message::Auth<TInterface, TProtOptions>);
            default: break;
        }
