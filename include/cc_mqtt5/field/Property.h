    ...
    struct ReceiveMaxMembers
    {
        ...
        class Value : public
            comms::field::IntValue<
                ...
                std::uint16_t,
                comms::option::def::HasName,
                comms::option::def::DefaultNumValue<65535>,
                comms::option::def::ValidNumValueRange<1, 65535>
            >
        {
            using Base =
                comms::field::IntValue<
...
public:
    ...
    using MemberNameInfo = cc_mqtt5::field::PropertyCommon::MemberNameInfo;

    /// @brief Type returned from @ref memberNamesMap() member function.
    /// @see @ref cc_mqtt5::field::PropertyCommon::MemberNamesMapInfo.
    using MemberNamesMapInfo = cc_mqtt5::field::PropertyCommon::MemberNamesMapInfo;
    ...
    /// @see @ref cc_mqtt5::field::PropertyCommon::memberName().
    static const char* memberName(std::size_t idx)
    {
        return cc_mqtt5::field::PropertyCommon::memberName(idx);
    }
    ...
    /// @see @ref cc_mqtt5::field::PropertyCommon::memberNamesMap().
    static MemberNamesMapInfo memberNamesMap()
    {
        return cc_mqtt5::field::PropertyCommon::memberNamesMap();
    }
