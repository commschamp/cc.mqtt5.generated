...
#include "cc_mqtt5/field/IdAndFlagsFieldCommon.h"
...
struct IdAndFlagsFieldMembers
{
    ...
    public:
        ...
        {
            return cc_mqtt5::field::IdAndFlagsFieldMembersCommon::FlagsCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_mqtt5::field::IdAndFlagsFieldMembersCommon::FlagsCommon::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_mqtt5::field::IdAndFlagsFieldMembersCommon::IdCommon::name();
        }
    };
...
public:
    ...
    ///         for cc_mqtt5::field::IdAndFlagsFieldMembers::Flags member field.
    ///     @li @b FieldIdx_id index, @b Field_id type and @b field_id() access function -
    ///         for cc_mqtt5::field::IdAndFlagsFieldMembers::Id member field.
    ...
    static const char* name()
    {
        return cc_mqtt5::field::IdAndFlagsFieldCommon::name();
    }
