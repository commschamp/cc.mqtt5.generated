...
#include "cc_mqtt5/factory/ClientInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_mqtt5::factory::ClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_mqtt5::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
