    ...
    struct ResponseTopicMembers
    {
        ...
        public:
            ...
            bool refresh()
            {
                ...
                Base::value() = static_cast<ValueType>(8);
                return true;
    ...
    struct SubscriptionIdMembers
    {
        ...
        public:
            ...
            bool refresh()
            {
                ...
                Base::value() = static_cast<ValueType>(11);
                return true;
    ...
    struct SessionExpiryIntervalMembers
    {
        ...
        public:
            ...
            bool refresh()
            {
                ...
                Base::value() = static_cast<ValueType>(17);
                return true;
    ...
    struct ServerKeepAliveMembers
    {
        ...
        public:
            ...
            bool refresh()
            {
                ...
                Base::value() = static_cast<ValueType>(19);
                return true;
    ...
    struct AuthMethodMembers
    {
        ...
        public:
            ...
            bool refresh()
            {
                ...
                Base::value() = static_cast<ValueType>(21);
                return true;
    ...
    struct WillDelayIntervalMembers
    {
        ...
        public:
            ...
            bool refresh()
            {
                ...
                Base::value() = static_cast<ValueType>(24);
                return true;
    ...
    struct ServerRefMembers
    {
        ...
        public:
            ...
            bool refresh()
            {
                ...
                Base::value() = static_cast<ValueType>(28);
                return true;
    ...
    struct TopicAliasMaxMembers
    {
        ...
        public:
            ...
            bool refresh()
            {
                ...
                Base::value() = static_cast<ValueType>(34);
                return true;
    ...
    struct MaxQosMembers
    {
        ...
        public:
            ...
            bool refresh()
            {
                ...
                Base::value() = static_cast<ValueType>(36);
                return true;
        ...
        /// @brief Definition of <b>"Value"</b> field.
        /// @see @ref mqtt5::field::PropertyMembersCommon::MaxQosMembersCommon::ValueCommon::ValueType
        class Value : public
            comms::field::EnumValue<
                mqtt5::field::FieldBase<>,
                mqtt5::field::PropertyMembersCommon::MaxQosMembersCommon::ValueCommon::ValueType,
                comms::option::def::ValidNumValueRange<0, 1>
            >
        {
            using Base =
        ...
        public:
            ...
            /// @brief Single value name info entry.
            using ValueNameInfo = mqtt5::field::PropertyMembersCommon::MaxQosMembersCommon::ValueCommon::ValueNameInfo;
            
            /// @brief Type returned from @ref valueNamesMap() member function.
            /// @see @ref mqtt5::field::PropertyMembersCommon::MaxQosMembersCommon::ValueCommon::ValueNamesMapInfo.
            using ValueNamesMapInfo = mqtt5::field::PropertyMembersCommon::MaxQosMembersCommon::ValueCommon::ValueNamesMapInfo;
            
            /// @brief Retrieve name of the enum value.
            /// @see @ref mqtt5::field::PropertyMembersCommon::MaxQosMembersCommon::ValueCommon::valueName().
            static const char* valueName(ValueType val)
            {
            ...
            /// @brief Retrieve map of enum value names.
            /// @see @ref mqtt5::field::PropertyMembersCommon::MaxQosMembersCommon::ValueCommon::valueNamesMap().
            static ValueNamesMapInfo valueNamesMap()
            {
                return mqtt5::field::PropertyMembersCommon::MaxQosMembersCommon::ValueCommon::valueNamesMap();
            }
    ...
    struct RetainAvailableMembers
    {
        ...
        public:
            ...
            bool refresh()
            {
                ...
                Base::value() = static_cast<ValueType>(37);
                return true;
    ...
    struct SubIdAvailMembers
    {
        ...
        public:
            ...
            bool refresh()
            {
                ...
                Base::value() = static_cast<ValueType>(41);
                return true;
    ...
    struct SharedSubAvailMembers
    {
        ...
        public:
            ...
            bool refresh()
            {
                ...
                Base::value() = static_cast<ValueType>(42);
                return true;
...
public:
    ...
    comms::ErrorStatus read(TIter& iter, std::size_t len)
    {
        ...
        default:
            initField_sharedSubAvail().field_id().value() = commonKeyField.value();
            return accessField_sharedSubAvail().template readFrom<1>(iter, len);
        };
