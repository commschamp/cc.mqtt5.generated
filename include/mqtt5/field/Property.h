...
struct PropertyMembers
{
    ...
    public:
        ...
        ///     @li @b Field_idtype and @b field_id() access function -
        ///         for PayloadFormatIndicatorMembers::Id member field.
        ///     @li @b Field_valuetype and @b field_value() access function -
    ...
    struct UserPropertyMembers
    {
        ...
        public:
            ...
            ///
            ///     The generated access types and functions functions are:
            ///     @li @b Field_firsttype and @b field_first() access function -
            ///         for ValueMembers::First member field.
            ///     @li @b Field_secondtype and @b field_second() access function -
...
public:
    ...
    ///     @li @b Field_payloadFormatIndicator type, @b initField_payloadFormatIndicator() and @b accessField_payloadFormatIndicator() access functions -
    ///     for PropertyMembers::PayloadFormatIndicator member field.
    ///     @li @b Field_messageExpiryInterval type, @b initField_messageExpiryInterval() and @b accessField_messageExpiryInterval() access functions -
    ///     for PropertyMembers::MessageExpiryInterval member field.
    ///     @li @b Field_contentType type, @b initField_contentType() and @b accessField_contentType() access functions -
    ///     for PropertyMembers::ContentType member field.
    ///     @li @b Field_responseTopic type, @b initField_responseTopic() and @b accessField_responseTopic() access functions -
    ///     for PropertyMembers::ResponseTopic member field.
    ///     @li @b Field_correlationData type, @b initField_correlationData() and @b accessField_correlationData() access functions -
    ///     for PropertyMembers::CorrelationData member field.
    ///     @li @b Field_subscriptionId type, @b initField_subscriptionId() and @b accessField_subscriptionId() access functions -
    ///     for PropertyMembers::SubscriptionId member field.
    ///     @li @b Field_sessionExpiryInterval type, @b initField_sessionExpiryInterval() and @b accessField_sessionExpiryInterval() access functions -
    ///     for PropertyMembers::SessionExpiryInterval member field.
    ///     @li @b Field_assignedClientId type, @b initField_assignedClientId() and @b accessField_assignedClientId() access functions -
    ///     for PropertyMembers::AssignedClientId member field.
    ///     @li @b Field_serverKeepAlive type, @b initField_serverKeepAlive() and @b accessField_serverKeepAlive() access functions -
    ///     for PropertyMembers::ServerKeepAlive member field.
    ///     @li @b Field_authMethod type, @b initField_authMethod() and @b accessField_authMethod() access functions -
    ///     for PropertyMembers::AuthMethod member field.
    ///     @li @b Field_authData type, @b initField_authData() and @b accessField_authData() access functions -
    ///     for PropertyMembers::AuthData member field.
    ///     @li @b Field_requestProblemInfo type, @b initField_requestProblemInfo() and @b accessField_requestProblemInfo() access functions -
    ///     for PropertyMembers::RequestProblemInfo member field.
    ///     @li @b Field_willDelayInterval type, @b initField_willDelayInterval() and @b accessField_willDelayInterval() access functions -
    ///     for PropertyMembers::WillDelayInterval member field.
    ///     @li @b Field_requestResponseInfo type, @b initField_requestResponseInfo() and @b accessField_requestResponseInfo() access functions -
    ///     for PropertyMembers::RequestResponseInfo member field.
    ///     @li @b Field_responseInfo type, @b initField_responseInfo() and @b accessField_responseInfo() access functions -
    ///     for PropertyMembers::ResponseInfo member field.
    ///     @li @b Field_serverRef type, @b initField_serverRef() and @b accessField_serverRef() access functions -
    ///     for PropertyMembers::ServerRef member field.
    ///     @li @b Field_reasonStr type, @b initField_reasonStr() and @b accessField_reasonStr() access functions -
    ///     for PropertyMembers::ReasonStr member field.
    ///     @li @b Field_receiveMax type, @b initField_receiveMax() and @b accessField_receiveMax() access functions -
    ///     for PropertyMembers::ReceiveMax member field.
    ///     @li @b Field_topicAliasMax type, @b initField_topicAliasMax() and @b accessField_topicAliasMax() access functions -
    ///     for PropertyMembers::TopicAliasMax member field.
    ///     @li @b Field_maxQos type, @b initField_maxQos() and @b accessField_maxQos() access functions -
    ///     for PropertyMembers::MaxQos member field.
    ///     @li @b Field_retainAvailable type, @b initField_retainAvailable() and @b accessField_retainAvailable() access functions -
    ///     for PropertyMembers::RetainAvailable member field.
    ///     @li @b Field_userProperty type, @b initField_userProperty() and @b accessField_userProperty() access functions -
    ///     for PropertyMembers::UserProperty member field.
    ///     @li @b Field_maxPacketSize type, @b initField_maxPacketSize() and @b accessField_maxPacketSize() access functions -
    ///     for PropertyMembers::MaxPacketSize member field.
    ///     @li @b Field_wildcardSubAvail type, @b initField_wildcardSubAvail() and @b accessField_wildcardSubAvail() access functions -
    ///     for PropertyMembers::WildcardSubAvail member field.
    ///     @li @b Field_subIdAvail type, @b initField_subIdAvail() and @b accessField_subIdAvail() access functions -
    ///     for PropertyMembers::SubIdAvail member field.
    ///     @li @b Field_sharedSubAvail type, @b initField_sharedSubAvail() and @b accessField_sharedSubAvail() access functions -
