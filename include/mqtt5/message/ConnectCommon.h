...
struct ConnectFieldsCommon
{
    ...
    {
        /// @brief Common types and functions for
        ///     @ref mqtt5::message::ConnectFields::WillTopicMembers::WillTopic field.
        struct WillTopicCommon : public mqtt5::field::StringCommon
        {
            /// @brief Name of the @ref mqtt5::message::ConnectFields::WillTopicMembers::WillTopic field.
            static const char* name()
            {
                return "Will Topic";
            }
