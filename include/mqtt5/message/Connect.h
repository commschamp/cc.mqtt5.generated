...
public:
    ...
    ///     @li @b Field_protocolVersion type and @b field_protocolVersion() access fuction
    ...
    ///     @li @b Field_properties type and @b field_properties() access fuction
    ...
    ///     @li @b Field_willProperties type and @b field_willProperties() access fuction
