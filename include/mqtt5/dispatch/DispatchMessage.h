...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref mqtt5::options::DefaultOptions.
/// @headerfile "mqtt5/dispatch/DispatchMessage.h"
...
struct MsgDispatcher
{
    ...
    static auto dispatch(mqtt5::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(mqtt5::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return mqtt5::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(mqtt5::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(mqtt5::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return mqtt5::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }
...
using MsgDispatcherDefaultOptions =
    MsgDispatcher<mqtt5::options::DefaultOptions>;
